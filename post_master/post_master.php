 ...
 <?php 
	 ...
	 if ($rs->num_rows > 0)
     {
         ...
         { ?>
			...
			<td colspan=2><h4><a href = <?php echo "../thread_comments/thread.php?id=". $row['post_master_id'] ;?>  name=  <?php echo $row['post_master_id']; ?> ><?php echo $row['post_heading'];  ?> </a></h4> </td>
			 <tr><td> </td></tr>
			</tr>
...
<a href = <?php formPost_Delete($row['post_master_id']) ?>  name=  <?php echo 'btn_Delete'.$row['post_master_id'];?> >Delete </a> &nbsp;
			       
<a href = <?php formPost_Archive($row['post_master_id']) ?>  name=  <?php echo 'btn_Archive'.$row['post_master_id'];?> >Archive </a>
				<?php }} ?>
